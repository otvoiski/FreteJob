 ...
 * @author Otavio
 */
public class FreteBuscarVeiculo extends javax.swing.JFrame {

    private final JTextField jtfVeiculoPlaca;
    private final JTextField veiculoCodigo;
    private final JFrame backWindows;
    JTextField jtfCapacidade;
     ...
     * @param backWindows
     * @param jtfveiculoCodigo
     * @param jtfveiculoPlaca
     * @param capacidade
     * @param veiculoID
     */
    public FreteBuscarVeiculo(JFrame backWindows,JTextField jtfveiculoCodigo, JTextField jtfveiculoPlaca,JTextField capacidade, int veiculoID) {
        initComponents();
        this.jtfVeiculoPlaca = jtfveiculoPlaca;
        this.backWindows = backWindows;
        this.veiculoId = veiculoID;
        this.veiculoCodigo = jtfveiculoCodigo;
        this.jtfCapacidade = capacidade;
        
        TableColumnModel columnModel = jtbVeiculos.getColumnModel();
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        try {
            List<JSONObject> veiculos = (new Controller.VeiculoController()).GetByPlaca(Util.Validacao.InputToString(jtfPlacaVeiculo));
            PreencheJTable(jtbVeiculos, veiculos);
        } catch (Error ex) {
    ...
    private void jbSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSelecionarActionPerformed
        try {       
            if(jtbVeiculos.getSelectedRow() != -1){
                veiculoId = Integer.parseInt(Util.Validacao.InputToString(new JTextField((String) Helper.GetValueJTable(jtbVeiculos, 0))));
                String capacidade = Util.Validacao.InputToString(new JTextField((String) Helper.GetValueJTable(jtbVeiculos, 1)));
                String placa = Util.Validacao.InputToString(new JTextField((String) Helper.GetValueJTable(jtbVeiculos, 2)));
                veiculoCodigo.setText(String.valueOf(veiculoId));
                jtfVeiculoPlaca.setText(placa);
                jtfCapacidade.setText(capacidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FreteBuscarVeiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FreteBuscarVeiculo(null, null,null,null,0).setVisible(true);
            }
        });
    }
